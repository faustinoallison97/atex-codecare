      ...
      <div id="sessao3" className={style.container_terceira_tela}>
        ...
        <div className={style.container_cards_terceira_tela}>
          <div className={style.container_card_terceira_tela}>
            ...
            <a href="" id={style.primeiro_link_redirecionar}>Ver mapa <MdOutlineArrowRightAlt /></a>
          </div>
          <div className={style.container_card_terceira_tela}>
            ...
            <a href="" id={style.segundo_link_redirecionar}>Ser voluntário <MdOutlineArrowRightAlt /></a>
          </div>
          <div className={style.container_card_terceira_tela}>
            ...
            <a href="" id={style.terceiro_link_redirecionar}>Ver impacto <MdOutlineArrowRightAlt /></a>
          </div>
        </div>
      </div>
    </div>
